...
attempt_classifier.py reads in the resulting csv generated by attempt_labeler.py and displays each interval for the user to view. After all intervals are processed, a final csv file containing attempt intervals and whether or not the attempt had a successful block drop will be generated.
