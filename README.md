...
3) Each attempt denoted the csv generated by label_generator.py will displayed in a new window for you to view. Press 'j' to go back 1 frame, and 'k' to go forward 1 frame. Press 'h' to go back 10 frames, and 'l' to go forward 10 frames.
